...
package com.google.cloud.healthcare.etl.runner.customtofhir;
...
import com.google.cloud.healthcare.etl.model.mapping.HclsApiCustomMappableMessage;
import com.google.cloud.healthcare.etl.model.mapping.HclsApiCustomMappableMessageCoder;
...
//import org.apache.beam.sdk.io.gcp.healthcare.CustomIO;
//import org.apache.beam.sdk.io.gcp.healthcare.CustomMessage;
 ...
 * fix this.
 */
public class CustomToFhirStreamingRunner {
  ...
  public static Pipeline createPipeline(String[] args) {
    ...
    MappingFn<HclsApiCustomMappableMessage> mappingFn =
        MappingFn.of(options.getMappingPath(), options.getEnablePerformanceMetrics());


    SimpleFunction<String, HclsApiCustomMappableMessage> toMessage =
        new SimpleFunction<String, HclsApiCustomMappableMessage>() {
          @Override
          public HclsApiCustomMappableMessage apply(String input) {
	    ...
	    System.out.println(input);
            return HclsApiCustomMappableMessage.from(input);
          }
        };
